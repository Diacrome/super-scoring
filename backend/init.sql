...
values (1, '1*1 = ', '{"1": 1, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30),
       ...
       (2, 'How old is your %answer?” – “She''s thirteen.”', '{"1": "brother", "2": "son", "3": "boyfriend", "4": "sister"}', '{"answer": "4"}', '[{ "url": "image/smile.jpg", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30),
       (2, 'Do you like horror movies?', '{"1": "Yes, I am", "2": "Yes, I like", "3": "Yes, I do", "4": "Yes, it is"}', '{"answer": "3"}', '[{ "url": "image/balloon.jpg", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30),
