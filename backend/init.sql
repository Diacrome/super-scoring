...
insert into question(test_id, question_wording, payload, answer, question_content, answer_type, date_created, date_modified,
                     time_limit,weight)
values (1, '1*1 = ', '{"1": 1, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '2*2 = ', '{"1": 1, "2": 4, "3": 4, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '3*3 = ', '{"1": 1, "2": 3, "3": 9, "4": 1}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '4*4 = ', '{"1": 1, "2": 3, "3": 4, "4": 16}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '5*5 = ', '{"1": 25, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '6*6 = ', '{"1": 1, "2": 36, "3": 4, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '7*7 = ', '{"1": 1, "2": 3, "3": 49, "4": 1}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '8*8 = ', '{"1": 1, "2": 3, "3": 4, "4": 64}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '9*9 = ', '{"1": 81, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '10*10 = ', '{"1": 100, "2": 1000, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '6*5 = ', '{"1": 1, "2": 30, "3": 35, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '7*6 = ', '{"1": 1, "2": 3, "3": 42, "4": 44}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '7*8 = ', '{"1": 1, "2": 3, "3": 4, "4": 56}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '8*9 = ', '{"1": 72, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '6*4 = ', '{"1": 1, "2": 24, "3": 4, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '2*3 = ', '{"1": 1, "2": 3, "3": 6, "4": 1}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '5*4 = ', '{"1": 1, "2": 3, "3": 4, "4": 20}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (1, '5*4 = ', '{"1": 1, "2": 20, "3": 4, "4": 20}', '{"multiple_answer1": "2", "multiple_answer2": "4"}', null,'MULTIPLE_CHOICE', now(), now(), 30,1),
       (2, 'Kang thought the spicy tofu dish was %answer tasty, so he ordered it again.', '{"1": "mainly", "2": "fairy", "3": "especially", "4": "slightly"}', '{"answer": "3"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'They’ve been married for over fifty years, but she still remembers the day she first %answer.', '{"1": "keen on him", "2": "stuck on him", "3": "fell for him", "4": "wed him"}', '{"answer": "3"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'She arrived at 8 p.m., opened the door and shouted “Good %answer!”', '{"1": "morning", "2": "evening", "3": "night", "4": "bye"}', '{"answer": "2"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'It %answer that our Earth is so safe and peaceful planet, doesn''t it?', '{"1": "seems", "2": "is seeming", "3": "seemed"}', '{"answer": "1"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'If I had had a lot of money yesterday, I would a car now.', '{"1": "have bought", "2": "buy", "3": "bought"}', '{"answer": "1"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'For the questions below, please choose the best option to complete the sentence or conversation. \n Can I park here?', '{"1": "Sorry, I did that.", "2": "It''s the same place.", "3": "Only for half an hour."}', '{"answer": "3"}', null, 'SINGLE_CHOICE', now(), now(), 30,1),
       (2, ' I''m sorry - I didn''t %answer to disturb you.', '{"1": "hope", "2": "think", "3": "mean", "4": "suppose"}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (2, '%answer tired Melissa is when she gets home from work, she always makes time to say goodnight to the children.', '{"1": "Whatever", "2": "No matter how", "3": "However much", "4": "Although"}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'How old is your %answer?” – “She''s thirteen.”', '{"1": "brother", "2": "son", "3": "boyfriend", "4": "sister"}', '{"answer": "4"}', '[{ "url": "image/smile.jpg", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'Do you like horror movies?', '{"1": "Yes, I am", "2": "Yes, I like", "3": "Yes, I do", "4": "Yes, it is"}', '{"answer": "3"}', '[{ "url": "image/balloon.jpg", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'Jane Smith – cacti gardener. Many people are fond %answer1 gardening but Jane is different from them – she %answer2 only cacti. As a young girl she liked watching how her mother took care of plants, trees, and bushes in their garden and Jane helped her a lot. Jane’s collection of cacti from all over the world reminds her of her mother and childhood.', '{"answer1":{"1": "plants", "2": "is planting", "3": "has planted"}, "answer2": {"1": "plants", "2": "is planting", "3": "has planted"}}', '{"answer1": "2", "answer2" : "3"}', null, 'MULTIPLE_QUESTIONS_SINGLE_CHOICE', now(), now(), 30,1),
       (2, 'Что произносится на видео?', '{"1": "Это мои предложения", "2": "Это мой офис", "3": "Это в моём офисе", "4": "Я у себя в офисе"}', '{"answer": "2"}', '[{ "url": "video/6246068703.mp4", "type": "video" }]', 'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Отопление: О наличии протечки в системе отопления могут сигнализировать:', '{"1": "неработающий отопитель салона транспортного средства", "2": "лужицы охлаждающей жидкости", "3": "ошибка запуска жидкостного подогревателя", "4": "характерный запах в салоне", "5": "непривычные шумы в работе штатного насоса"}', '{"multiple_answer1": "2", "multiple_answer2": "4"}', null,'MULTIPLE_CHOICE', now(), now(), 30,2),
       (3, 'Отопление: Какое устройство системы отопления может работать автономно при неработающем двигателе?', '{"1": "Водяной насос", "2": "Конвекторный отопитель", "3": "Электровентилятор", "4": "Предпусковой подогреватель"}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Кондиционеры: Заполните пробел: в устройстве кондиционера можно выделить %answer контура/контуров давлени', '{"1": 2, "2": 3, "3": 4, "4": 5}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Кондиционеры: Определите последовательность заправочных работ с кондиционером при помощи заправочной станции', '{"1": "Закачать фреон в систему", "2": "Вакуумизировать систему", "3": "Откачать фреон и сторонние жидкости", "4": "Задать программу"}', '{"1": "4", "2": "3", "3": "2", "4": "1"}', null,'RANKING', now(), now(), 30,2),
       (3, 'Тормозная система: Гидравлический привод тормозной системы может включать в себя:', '{"1": "тормозные ленты", "2": "усилитель тормозов", "3": "тормозную педаль", "4": "тормозной барабан", "5": "соединительные шланги и трубопроводы"}', '{"multiple_answer1": "2", "multiple_answer2": "3", "multiple_answer3": "5"}', null,'MULTIPLE_CHOICE', now(), now(), 30,2),
       ...
       (3, 'Силовой агрегат, КПП, карданный вал: Правильными действиями при демонтаже силового агрегата являются:', '{"1": "зафиксировать брызговик двигателя", "2": "отсоединить провода от клеммы аккумуляторной батареи", "3": "закрепить привод спидометра", "4": "слить жидкость из системы охлаждения", "5": "слить масло коробки передач"}', '{"multiple_answer1": "2", "multiple_answer2": "4", "multiple_answer3": "5"}', null,'MULTIPLE_CHOICE', now(), now(), 30,2),
       (3, 'Силовой агрегат, КПП, карданный вал: Клиноременной вариатор является деталью', '{"1": "гидромеханической автоматической коробки передач", "2": "бесступенчатой коробки передач", "3": "роботизированной коробки передач", "4": "механической коробки передач"}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Двигатель: Расставьте такты рабочего цикла двигателя внутреннего сгорания в правильном порядке', '{"1": "Рабочий ход (расширение)", "2": "Впуск", "3": "Выпуск", "4": "Сжатие"}', '{"1": "2", "2": "4", "3": "1", "4": "2"}', null,'RANKING', now(), now(), 30,2),
       (3, 'Двигатель: На первоначальном этапе запуска поршневого двигателя внутреннего сгорания происходит', '{"1": "зажигание свечи", "2": "движение поршня", "3": "раскрутка маховика стартером", "4": "открытие впускного клапана"}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       ...
       (3, 'Мосты и подвески: В основе конструкции амортизаторов могут использоваться', '{"1": "муфты с резиновыми упругими элементами", "2": "металлические пружины", "3": "пластины из полимеров с различными добавками", "4": "гидравлические устройства", "5": "пневматические баллоны"}', '{"multiple_answer1": "1", "multiple_answer2": "2", "multiple_answer3": "4", "multiple_answer4": "5"}', null,'MULTIPLE_CHOICE', now(), now(), 30,2),
       (3, 'Рулевое управление: При каком максимальном значении суммарного люфта в рулевом управлении допускается эксплуатация легкового автомобиля и микроавтобуса?', '{"1": "15°", "2": "10°", "3": "20°", "4": "5°"}', '{"answer": "2"}', null,'SINGLE_CHOICE', now(), now(), 30,2),
       (3, 'Рулевое управление: Оцените корректность утверждений:\nЧастыми поломками гидроусилителя руля могут выступать следующие:\nА) Течь шланга гидроусилителя\nБ) Течь рабочей жидкости из мест соединений', '{"1": "Вариант А верный, Б — неверный", "2": "Вариант Б верный, А — неверный", "3": "А и Б неверны", "4": "А и Б верны"}', '{"answer": "4"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Электрика: Оцените корректность утверждений:\nТермоусадочная изоляция применяется при электроремонте:\nА) для изоляции токоведущих частей\nБ) для защиты от окисления кислородом', '{"1": "Вариант Б верный, А неверный", "2": "А и Б неверны", "3": "А и Б верны", "4": "Вариант А верный, Б неверный"}', '{"answer": "3"}', null,'SINGLE_CHOICE', now(), now(), 30,1),
       (3, 'Электрика: В чем заключаются особенности измерения величины тока мультиметром?', '{"1": "Выключатель измерительного прибора прерывает электрическую цепь", "2": "Мультиметр используется в качестве амперметра", "3": "Для предотвращения разрушения прибора от перегрузок может использоваться предохранитель ", "4": "Мультиметр подключается параллельно в электрическую цепь"}', '{"multiple_answer1": "2", "multiple_answer2": "3"}', null,'MULTIPLE_CHOICE', now(), now(), 30,2),
       (3, 'Топливная система: Оцените корректность утверждений:\nА) Инжекторные системы подачи топлива, по сравнению с карбюраторными,  более точно дозируют топливо и обеспечивают более экономный его расход\nБ) В устройстве инжекторного двигателя с распределенным впрыском имеется одна форсунка, подающая  топливо для всех цилиндров двигателя', '{"1": "Вариант А верный, Б — неверный", "2": "Вариант А неверный, Б — верный", "3": "А и Б верны", "4": "А и Б неверны"}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30,2),
...
values (1, '1*1 = ', '{"1": 1, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', 1, now(), now(), 30),
       ...
       (1, '6*5 = ', '{"1": 1, "2": 30, "3": 35, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', 2, now(), now(), 30),
       ...
       (2, 'Everybody hold on %answer the tree.  (нужно понять, что произносят на видео)', '{"1": "in", "2": "out", "3": "to", "4": "at"}','{"answer": "3"}', '[{ "url": "video/09a67c515c.mp4", "type": "video" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'Что произносится на видео?', '{"1": "Когда это?", "2": "Где это?", "3": "Что это?", "4": "Откуда это?"}', '{"answer": "2"}', '[{ "url": "video/48162aaadc.mp4", "type": "video" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'Какое высказывание соответствует озвученной информации?', '{"1": "Prices in Ikea depend on what people purchase more often", "2": "Ikea offers a wide range of products", "3": "Ikea mostly sells affordable goods", "4": "Ikea’s furniture is out of most people’s price range"}', '{"answer": "3"}', '[{ "url": "video/c37e7077c0.mp4", "type": "video" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'Вставьте правильный артикль, если он необходим:', '{"1": "an", "2": "–", "3": "a", "4": "the"}', '{"answer": "4"}', '[{ "url": "image/submorina.png", "type": "image" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'When do you play tennis? - %answer Fridays.', '{"1": "On", "2": "By", "3": "In", "4": "At"}', '{"answer": "1"}', '[{ "url": "image/racket.png", "type": "image" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'Выберите правильный вариант:', '{"1": "don''t, understands", "2": "don''t, understand", "3": "doesn''t, understand", "4": "doesn''t, understands"}', '{"answer": "4"}', '[{ "url": "image/coffee.png", "type": "image" }]', 'SINGLE_CHOICE', now(), now(), 30),
       (2, 'Выберите правильный вариант перевода: \n Ему следует убрать свою комнату', '{"1": "He should clean up his room", "2": "He needs to remove his room", "3": "He must clean up his room", "4": "He has to remove his room"}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30),
