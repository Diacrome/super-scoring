...
values (1, '1*1 = ', '{"1": 1, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', 1, now(), now(), 30),
       (1, '2*2 = ', '{"1": 1, "2": 4, "3": 4, "4": 1}', '{"answer": "2"}', null,'SINGLE_CHOICE', 2, now(), now(), 30),
       (1, '3*3 = ', '{"1": 1, "2": 3, "3": 9, "4": 1}', '{"answer": "3"}', null,'SINGLE_CHOICE', 1, now(), now(), 30),
       (1, '4*4 = ', '{"1": 1, "2": 3, "3": 4, "4": 16}', '{"answer": "4"}', null,'SINGLE_CHOICE', 2, now(), now(), 30),
       (1, '5*5 = ', '{"1": 25, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', 2, now(), now(), 30),
       ...
       (1, '8*8 = ', '{"1": 1, "2": 3, "3": 4, "4": 64}', '{"answer": "4"}', null,'SINGLE_CHOICE', 2, now(), now(), 30),
       ...
       (1, '5*4 = ', '{"1": 1, "2": 20, "3": 4, "4": 20}', '{"multiple_answer1": "2", "multiple_answer2": "4"}', null,'MULTIPLE_CHOICE', 2, now(), now(), 30),
