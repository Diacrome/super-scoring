...
values (1, '1*1 = ', '{"1": 1, "2": 3, "3": 4, "4": 1}', '{"answer": "1"}', null,'SINGLE_CHOICE', now(), now(), 30),
       ...
       (2, 'How old is your %answer?” – “She''s thirteen.”', '{"1": "brother", "2": "son", "3": "boyfriend", "4": "sister"}', '{"answer": "4"}', '[{ "url": "image/smile.png", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30),
       (2, 'Do you like horror movies?', '{"1": "Yes, I am", "2": "Yes, I like", "3": "Yes, I do", "4": "Yes, it is"}', '{"answer": "3"}', '[{ "url": "image/balloon.png", "type": "image" }]','SINGLE_CHOICE', now(), now(), 30),
       ...
       (2, 'Что произносится на видео?', '{"1": "Это мои предложения", "2": "Это мой офис", "3": "Это в моём офисе", "4": "Я у себя в офисе"}', '{"answer": "2"}', '[{ "url": "video/6246068703.mp4", "type": "video" }]', 'SINGLE_CHOICE', now(), now(), 30),
       ...
       (3, 'Кондиционеры: Определите последовательность заправочных работ с кондиционером при помощи заправочной станции', '{"1": "Закачать фреон в систему", "2": "Вакуумизировать систему", "3": "Откачать фреон и сторонние жидкости", "4": "Задать программу"}', '{"1": "4", "2": "3", "3": "2", "4": "1"}', null,'RANKING', now(), now(), 30),
       ...
       (3, 'Двигатель: Расставьте такты рабочего цикла двигателя внутреннего сгорания в правильном порядке', '{"1": "Рабочий ход (расширение)", "2": "Впуск", "3": "Выпуск", "4": "Сжатие"}', '{"1": "2", "2": "4", "3": "1", "4": "2"}', null,'RANKING', now(), now(), 30),
